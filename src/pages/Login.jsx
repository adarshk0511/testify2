      ...
      <div className="flex min-h-screen items-center justify-center " style={{ backgroundImage: "url('/src/assets/aaabstract.webp')" }}>
          <div className=" max-w-7xl flex flex-col md:flex-row items-center bg-transparent rounded-lg shadow-lg overflow-hidden ml-30 mr-30">
            ...
            <div className="w-full md:w-1/2 p-6 md:p-10">
              <h1 className="text-5xl font-bold text-gray-800 text-center mb-10"><span className='bg-gradient-to-r from-orange-400 to-orange-700 text-transparent bg-clip-text'>Login</span></h1>
              <form>
                <div className="mb-4">
              ...
              <div className="mt-4 text-center">
                <a href="/testify2/signup" className="text-sm text-blue-500 hover:underline">
                  Create an account
                </a>
              </div>
              <div className="mt-6">
